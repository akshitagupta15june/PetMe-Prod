...
<a href="https://akshitagupta15june.github.io/PetMe-Prod/"><p align="center">The test site for the project can be found here.</p></a>
...
For a brief explanation about PetMe-Prod, you can watch the following video.

[<img src="https://i.imgur.com/8gEUuwt.png" width="50%">](https://youtu.be/u6ZcPOkCZnk)

## View our Website:

Click the image below to view our website!

[<img src="https://cdn.discordapp.com/attachments/1004464884773306368/1028310089364406363/unknown.png"/>](https://akshitagupta15june.github.io/PetMe-Prod/)
...
**1.** Start by making a Fork of the [**PetMe-Prod**](https://github.com/akshitagupta15june/PetMe-Prod/) repository. Click on the <a href="https://github.com/akshitagupta15june/PetMe/fork"><img src="https://i.imgur.com/G4z1kEe.png" height="21" width="21"></a>Fork symbol at the top right corner.

**2.** Clone your new fork of the repository in the terminal/CLI on your computer with the following command:

```bash
git clone https://github.com/<your-github-username>/PetMe-Prod
```
...
```bash
git remote add upstream https://github.com/Susmita-Dey/PetMe-Prod.git
```
...
**11.** **Congratulations!** You've made your first contribution to [**PetMe-Prod**](https://github.com/akshitagupta15june/PetMe-Prod/graphs/contributors)! 🙌🏼

#### For more details, refer to [CONTRIBUTING.md](/CONTRIBUTING.md) file.
### ⭐ How to run project locally 
**1.** Start by making a Fork of the [**PetMe-Prod**](https://github.com/akshitagupta15june/PetMe-Prod/) repository. Click on the <a href="https://github.com/akshitagupta15june/PetMe-Prod/fork"><img src="https://i.imgur.com/G4z1kEe.png" height="21" width="21"></a>Fork symbol at the top right corner.

**2.** After cloning Repo:

**3.** Steps for running project
  ## Steps for running FrontEnd 
    * Redirect to PetMe-Frontend using cd apps/PetMe-Frontend
    * npm i (For package instalation)
    * npm run dev (for running in local)

  ## Steps for running BackEnd
    * Redirect to PetMe-Backend using cd apps/PetMe-Backend
    * npm i (For package instalation)
...
<p>
  <img src="https://api.vaunt.dev/v1/github/entities/akshitagupta15june/repositories/PetMe-Prod/contributors?format=svg&limit=54" width="600" height"250" />
</p>
